...
const QueryView = ({ item }) => {
    ...
    const sendProcessing = async (email, refID) => {
        ...
        try {
            await fetch("/api/users/send-email/pay-processing-fee", { method: "POST", body: JSON.stringify({ refId: refID, to: email }), headers: { 'Contnet-Type': "application/json" } });
                ...
                <div className="admin_actions" >
                    <div className="docs_options" >
                        ...
                        <div className="options">
                            <label className="processing" >Processing</label>
